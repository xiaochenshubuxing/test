...
<body>
<jsp:include page="top.jsp"><jsp:param name="menu" value="orders" /><jsp:param name="menutip" value="My Self Pwd" /></jsp:include>
<div id="middle" style="height:calc(100% - 82px);">
	 <div id="product_info" style="width:950px;margin:0 auto;margin-top:10px">
			...
			<div style="margin-top:5px">
				 <form id="info" name="info" action="page_saveUserFrontPass.action" method="post" style="width:100%;height:100%">     
